...
class AppColors {
  ...
  // ============================================
  // Profile & Avatar Colors (단색 - 그라디언트 대체용)
  // ============================================
  static const Color profileBackground = Color(0xFF2A2A30);
  static const Color profileBorder = Color(0xFF3A3A42);
  static const Color profileLight = Color(0xFF3E3E46);

  // ============================================
  // Chat Bubble Colors (말풍선용 단색)
  // ============================================
  static const Color bubbleCast = Color(0xFF2E2E36);      // 캐스트 메시지
  static const Color bubbleCastBorder = Color(0xFF3A3A44);
  static const Color bubbleUser = deepSlate;              // 사용자 메시지
